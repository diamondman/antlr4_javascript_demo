...
var CalculatorListenerRPNImpl = require('./CalculatorListenerRPNImpl');
...
var listener = new CalculatorListenerRPNImpl.CalculatorListenerRPNImpl;
//listener.loginfo=true;
antlr4.tree.ParseTreeWalker.DEFAULT.walk(listener, tree);
console.log("RESULT:", listener.value.join(' '))
